...
[![Rectangular Search 1](img/rectangular-search-1.png)](./img/rectangular-search-1.png)
...
[![Rectangular Search 2](img/rectangular-search-2.png)](./img/rectangular-search-2.png)
...
[![Rectangular Search 3](img/rectangular-search-3.png)](./img/rectangular-search-3.png)

### Proximity Radius Search

To filter by proximity, click on the circle icon in the top right-hand corner of the map.

[![Radius Search 1](img/radius-search-1.png)](./img/radius-search-1.png)
...
[![Radius Search 2](img/radius-search-2.png)](./img/radius-search-2.png)
...
[![Radius Search 3](img/radius-search-3.png)](./img/radius-search-3.png)

### Spatial Layer Search

To filter by spatial layers, hover your mouse over the layers icon on the right-hand side of the map.

[![Spatial Layer Search 1](img/spatial-layer-search-1.png)](./img/spatial-layer-search-1.png)

Select the spatial layer you want to apply and then move your mouse off the layers popup.

[![Spatial Layer Search 2](img/spatial-layer-search-2.png)](./img/spatial-layer-search-2.png)

This example chose the Provinces layer.

[![Spatial Layer Search 3](img/spatial-layer-search-3.png)](./img/spatial-layer-search-3.png)
...
[![Spatial Layer Search 4](img/spatial-layer-search-4.png)](./img/spatial-layer-search-4.png)
...
[![Temporal Search 1](img/temporal-search-1.png)](./img/temporal-search-1.png)

Click on the `Calendar` icon, located on the right of the start and end date fields.

[![Temporal Search 2](img/temporal-search-2.png)](./img/temporal-search-2.png)

To set your extent to today's date select 1️⃣ `Today`, and if you wish to remove your chosen date click on 2️⃣ `Clear`.

[![Temporal Search 3](img/temporal-search-3.png)](./img/temporal-search-3.png)
...
[![Organisation Search 1](img/organisation-search-1.png)](./img/organisation-search-1.png)

To deselect the organisations, just click on the little `x` that will appear next to a selected organisation.

[![Organisation Search 2](img/organisation-search-2.png)](./img/organisation-search-2.png)
...
[![Other Searches 1](img/other-searches-1.png)](./img/other-searches-1.png)
...
[![Save Search 1](img/save-search-1.png)](./img/save-search-1.png)
...
[![Save Search 2](img/save-search-2.png)](./img/save-search-2.png)

Once you select it, the icon will be filled.

[![Save Search 3](img/save-search-3.png)](./img/save-search-3.png)
...
[![Save Search 5](img/save-search-5.png)](./img/save-search-5.png)
...
[![Save Search 6](img/save-search-6.png)](./img/save-search-6.png)
