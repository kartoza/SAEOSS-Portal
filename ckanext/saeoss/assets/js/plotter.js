// if one of the plots are showing the other isn't, this was a trial to re-implement the same js module
// to each plot will be different, still problematic

this.ckan.module('plotter', function (jQuery) {
    return {
      ...
      draw: function () {
        if (!this.drawn && this.canvas.is(':visible')) {
          console.log(this.drawn, this.canvas.is(':visible'), this.canvas, this.data, this.options)
